...
contract dossiermedical {
  ...
  function addRecord(string memory _title, address _patientId) public senderIsDoctor patientExists(_patientId) {
    Record memory record = Record(_title, _patientId, msg.sender, block.timestamp);
